<?php
  include $root.'/components/functions/confirmEditMemberFunction.php';
  include $root.'/components/functions/settingsFunction.php';
?>


<div class="container">
<?php if($_GET['action']=='update' && isset($_GET['id'])) { ?>

  <div class="row">
    <div class="col-md-8 offset-md-2">

      <div class="edit-member">
        <h2>Confirm Update Member</h2>
        <hr>
        <form action="" method="post" enctype="multipart/form-data">


            <input type="hidden" name="member_id" value="<?= $member[0]->member_id ?>">
            <div class="row">
              <div class="col-md-5">
